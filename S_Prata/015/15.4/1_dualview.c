...
void show_settings1(unsigned int); // функция, основана на представлени unsigned short 
...
{ 	
	...
	//=================== изменяем настройки // работаем с битами	
...
// побитовых операции: логические операции и операции сдвига.
void show_settings1(unsigned int us) // us явно не инициализирована поэтому равна нулю
{
    printf("box is %s.\n",
           (us & OPAQUE) == OPAQUE? "opaque": "transparent"); // #define OPAQUE  0x1
    printf("The fill color is %s.\n",
           colors[(us >> 1) & 07]); //07 это 0111
    printf("Border %s.\n",
